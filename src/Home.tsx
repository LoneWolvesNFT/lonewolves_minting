        ...
        <main>
            <MainContainer>
                <WalletContainer>
                    ...
                    <Menu>
                        <li><a href="https://discord.gg/lonewolves" target="_blank" rel="noopener noreferrer"><img alt="" src="discord.png" width="auto"/></a>
                        </li>
                        <li><a href="https://twitter.com/LoneWolves_NFT" target="_blank" rel="noopener noreferrer"><img alt="" src="twitter.png" width="auto"/></a>
                        </li>
                    </Menu>
                    <Wallet>
                        {wallet ?
